  ...
  mounted() {
    ...
    this.tableColumns = [
      ...
      },
      {
        ...
        name: "Title",
        class:
          "border-b border-gray-300 px-5 py-5 text-xs dark:border-gray-500",
      },
      {
        id: "body",
        type: "string",
        ...
        render: function (
            ...
            buttons: [
              {
                ...
                show_name: false,
                class:
                  "button inline-flex items-center justify-center px-4 py-3 mb-1 whitespace-nowrap rounded text-base font-medium leading-none shadow-sm transition duration-150 ease-in-out text-white dark:text-white bg-green-600 hover:bg-green-900 dark:bg-green-600 dark:hover:bg-green-400 border-green-600 hover:border-green-900 dark:border-green-600 dark:hover:border-green-400 border-1 border mr-2 px-1 py-1 text-sm",
                order: 0,
          ...
          return (
            (data ? data : "") +
            " " +
            JovencioDatatableCommon.providerButtonDT(provider, self)
          );
        },
      },
      {
      ...
      },
      {
        ...
        searchable: false,
        class:
          "whitespace-nowrap border-b border-gray-300 px-5 py-5 text-sm dark:border-gray-500",
        render: function (
          data: any,
          type: string,
          row: any,
            ...
            buttons: [
              {
                ...
                name: "Block/Unblock",
                show_name: false,
                class: `button inline-flex items-center justify-center px-4 py-3 mb-1 whitespace-nowrap rounded text-base font-medium leading-none shadow-sm transition duration-150 ease-in-out bg-gray-400 focus:bg-gray-400 active:bg-gray-400 dark:focus:bg-gray-400 dark:active:bg-gray-400 dark:hover:bg-gray-400 mr-2 inline-block rounded px-1 py-1 text-sm font-medium leading-snug leading-snug text-gray-700 shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg dark:text-white" btn-hover-class="hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-400 dark:focus:bg-gray-400 dark:active:bg-gray-400 dark:hover:bg-gray-400" btn-class-dark="bg-gray-400 focus:bg-gray-400 active:bg-gray-400 dark:focus:bg-gray-400 dark:active:bg-gray-400 dark:hover:bg-gray-400" btn-hover-class-dark="hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-400 dark:focus:bg-gray-400 dark:active:bg-gray-400 dark:hover:bg-gray-400`,
                order: 1,
